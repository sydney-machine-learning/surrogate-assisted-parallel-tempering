...
def main():
	...
	for i in range(5, 8) :
		for num_rep in range(2, 12, 2) :
			...
			problemfolder = '/home/rohit/Desktop/PT/PT_numreplica/'  # change this to your directory for results output - produces large datasets

			problemfolder_db = 'ptcanonical_numreplica/'  # save main results
