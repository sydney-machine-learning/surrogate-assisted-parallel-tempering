...
#python surrogate_pt_classifier_rw.py 3 20000   0.5  0.05  surr_lap/

#python surrogate_pt_classifier_rw.py 3 50000   0.5  0.05  surr_lap/


#python surrogate_pt_classifier_rw.py 4 20000   0.5  0.05  surr_lap/

#python surrogate_pt_classifier_rw.py 4 50000   0.5  0.05  surr_lap/
