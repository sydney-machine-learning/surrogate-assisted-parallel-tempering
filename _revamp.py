...
class ParallelTempering:
    ...
    def run_chains(self):
        ...
        swap_perc = 0#self.num_swap*100/self.total_swap_proposals
...
#problem ={ i
    ...
    surrogate_interval =   int(surrogate_intervalratio * (Samples/num_chains))

    print("Surrogate interval -----------------------> : {}".format(surrogate_interval))

    problemfolder = '/home/rohit/Desktop/SurrogatePTrevamp/'+foldername  # change this to your directory for results output - produces large datasets
...
#Statements
    ...
    resultingfile = open('master_result_file.txt','a+')
    resultingfile_db = open('master_result_file.txt','a+')
